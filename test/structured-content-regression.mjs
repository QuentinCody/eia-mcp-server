...
console.log(`${BLUE}🧪 EIA Structured Content Regression Tests${RESET}`);

const indexContent = readFile('src/index.ts');
assertContains('src/index.ts', indexContent, 'EiaDataDO', 'index.ts exports EiaDataDO');
...
assertContains('src/tools/code-mode.ts', codeModeContent, 'eiaCatalog', 'code-mode.ts imports eiaCatalog');
...
assertContains('src/spec/catalog.ts', catalogContent, 'EIA', 'catalog.ts names the API');
...
console.log(`\n${GREEN}✅ EIA structured content regression tests passed.${RESET}`);
